...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    UIColor *textColor = [UIColor colorWithRed:230.0/255.0 green:25.0/255.0 blue:111.0/255.0 alpha:1.0f];
    NSDictionary *attrs = @{ NSForegroundColorAttributeName : textColor, NSFontAttributeName : font};
    
    NSAttributedString *attStr = [[NSAttributedString alloc]initWithString:note.title attributes:attrs]
    ;
